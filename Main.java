...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        nextId = manager.getMaxId() + 1; // resume IDs after the highest loaded ID
        int choice;
        do {
            printMenu();
            ...
            switch (choice) {
                ...
                case 3: viewTransaction();break;
                case 4: updateTransaction();break;
                case 5: deleteTransaction();break;
                case 6: manager.displayAllTransactions();break;
                case 7: saveAndWait();break;
