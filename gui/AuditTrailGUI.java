...
public class AuditTrailGUI extends JPanel {
    ...
    /** Bottom info bar explaining audit trail is read-only / auto-generated */
    private JPanel buildInfoPanel() {
        JPanel p = new JPanel(new FlowLayout(FlowLayout.LEFT, 0, 8));
        p.setBackground(Theme.BG_DARK);

        JLabel info = new JLabel(
            "\uD83D\uDEC1  Audit records are generated automatically when users, transactions, or gateways are modified.");
    ...
    private void reload() {
        loadAudits(tfSearch.getText(), (String) cbOpFilter.getSelectedItem());
    }

    private void loadAudits(String search, String opFilter) {
        model.setRowCount(0);
