...
public class PaymentLogGUI extends JPanel {
    ...
    private JPanel buildHeader() {
        ...
        tfSearch.getDocument().addDocumentListener(new javax.swing.event.DocumentListener() {
            public void insertUpdate(javax.swing.event.DocumentEvent e)  { loadLogs(tfSearch.getText()); }
            public void removeUpdate(javax.swing.event.DocumentEvent e)  { loadLogs(tfSearch.getText()); }
            public void changedUpdate(javax.swing.event.DocumentEvent e) { loadLogs(tfSearch.getText()); }
        });
        ...
        btnRefresh.addActionListener(e -> { loadDropdown(); loadLogs(tfSearch.getText()); });
    ...
    private JPanel buildForm() {
        ...
        formPanel.add(fl("Transaction")); formPanel.add(Box.createVerticalStrut(4)); formPanel.add(cbTransaction);
        formPanel.add(Box.createVerticalStrut(12));
        formPanel.add(fl("Log Message")); formPanel.add(Box.createVerticalStrut(4)); formPanel.add(msgScroll);
        formPanel.add(Box.createVerticalStrut(20));
